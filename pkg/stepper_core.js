/* @ts-self-types="./stepper_core.d.ts" */
 ...
 * @returns {string}
 */
export function current_render() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.current_render();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {Uint32Array}
 */
export function foldable_ids() {
    const ret = wasm.foldable_ids();
 ...
 * @returns {Element}
 */
export function render_program() {
    const ret = wasm.render_program();
    return ret;
}
 ...
 * @param {number} width
 */
export function set_width(width) {
    wasm.set_width(width);
}
 ...
 * @returns {string}
 */
export function step_formula() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.step_formula();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {boolean}
 */
export function toggle_collapse(node_id) {
    const ret = wasm.toggle_collapse(node_id);
    return ret !== 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('stepper_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
